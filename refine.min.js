 ...
 * Update: 06/23/2014
 */
(function(R){"function"===typeof define&&define.amd?define("object"!==typeof document||"loading"!==document.readyState?[]:"refine",R):R()})(function(){function S(c,d){return function(){throw Error("'"+c+"' property is "+(d?"read":"write")+"-only");}}function W(c){return function(){return c}}function m(c,d,j,f,G){function h(){var a=this instanceof T,b=arguments;if(!a&&!(this instanceof h))return P.call(h,b[0]);var d=K,k=p,l=G.apply({isParent:a,options:f},a?b[0]:b),m=a&&b[3]||p,g=L||m||l,n=a?b[1]:{a:l},q=!a||b[2]===D||z!==D?z:b[2];for(E(C,function(a,e){F.call(l,a)||(l[a]=e)});d--;)if("function"!==typeof j[d]&&("string"===typeof j[d]?
j[d]=X(j[d],c):(j[d]=W(j[d]),q=q===D?Q:q)),v.prototype=k=j[d].call(new T,b,n,q,m),0<d&&(n.i=p),g=m=new v,!q)g.parent=k,Y&&(g.__proto__=k);if(K||a||L){var o=function(a){return q?a:"function"===typeof a?function(){var e=n.a,c=e.parent;!q&&(e.parent=k);var b=a.apply(this===g||this==i?e:this,arguments);!q&&(e.parent=c);return b}:a};E(l,function(a,e){if(e&&"object"===typeof e&&("set"in e&&(e.set=o(e.set)),"get"in e))e.get=o(e.get);g[a]=o(e)});n.a=a?n.a:g}q||(g.__refine__=h);if(!a&&0!==w){if(!A||B)E(B?
...
N]}catch(V){}L=A?p:(z=Q,a[b--])}f=!a[b]||a[b]instanceof J||"object"!==typeof a[b]?"boolean"===typeof a[b]||"number"===typeof a[b]?{compact:a[b--]}:{}:a[b--];z=z||f.compact;k=f.context;o=f.extend;y=f.mixins;C=f.statics||(k||o||y||"compact"in f?{}:f);j=a[b]instanceof J?a[b--]:"function"===typeof a[b]?[a[b--]]:"string"===typeof a[b-1]&&(""+a[b--]).replace(/(^|\s)(extends|implements)(\s|$)/g,",").replace(/^[\s,]+|\s(?=\s)|[\s,]+$/g,"").replace(/\s*,\s*/g,",").split(",")||[];l="string"===typeof a[b]&&
a[b--].split(/extends|implements|,/g)||[];c=a[b--]||k||m.refineScope||(m.refineScope=i);d=(l.shift()||"").replace(/^\s+|\s+$/g,"");k=(l=l.join(",").replace(/^[\s,]+|[\s,]+$/g,"").replace(/\s*,\s*/g,","))?l.split(","):[];o=(o=o||[])instanceof J?o:[o];y=(y=y||[])instanceof J?y:[y];j=k.concat.call(k,j.concat.call(j,o.concat.call(o,y)));if(!(K=j.length)&&!(d||z!==D))z=Q;if("function"!==typeof G)var U=G,G=function(){v.prototype=U.constructor.prototype;l=new v;E(U,function(a,b){l[a]=b});return l};h.toString=
function(){return"[object "+(d||"Function")+"]"};h.getInstanceOf=P;h.baseContext=c;E(C,function(a,b){h[a]=b});if(h.b=d){k=c;a=(l=d.split(".")).shift();do 0===l.length?k[t=a]=h:(a in k||(k[a]={}),k=k[a]);while(a=l.shift())}return O?new h:h}function O(c,d){var j=p,f=d,i,h;if("string"===typeof c){for(h=c.split(".");(i=h.shift())&&(d=d[i]););"function"===typeof d&&f===d.baseContext&&(j=d)}return j}function X(c,d){var j=O(c,d)||O(c,i)||"function"===typeof m.autoload&&m.autoload(c,d)||p;if(!j)throw Error("Parent constructor '"+
c+"' not Initialized or Undefined");return j}function E(c,d,j){var f,i=t.length,h;for(f in c)if(h=c[f],(j&&h!==s.prototype[f]||F.call(c,f))&&d.call(h,f,h)===C){i=C;break}if(i&&V)for(f=0;f<i&&!(h=c[t[f]],(F.call(c,t[f])||j&&t[f]in c&&h!==s.prototype[t[f]])&&d.call(h,t[f],h)===C);f++);}function P(c){for(;c&&c.__refine__!=p;){if(c.__refine__===this)return c;c=s.getPrototypeOf?s.getPrototypeOf(c):c.__proto__}return p}var Q=!0,C=!1,p=null,D=void 0,i=("object"===typeof window?window:this)||{},J=i.Array,
s=i.Object,T=i.Boolean,H=s.defineProperty,F=s.prototype.hasOwnProperty,Y=!(s.getPrototypeOf||s.prototype.__proto__),v=function(){return function(){}}(),N=(new Date).getTime(),V=!{toString:1}.propertyIsEnumerable("toString"),t="toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" ");m.instanceOf=function(c,d){return!!P.call(d,c)};var I=function(c){function d(d){c=d}try{H(c,"t",{set:d})}catch(j){try{c.__defineSetter__("t",d)}catch(f){}}c.t=0;c&&(c=1,
"execVBscript"in i||("execScript"in i?i.execScript("Function execVBscript(code) ExecuteGlobal(code) End Function\nFunction VBCorrectVal(o,r) If IsObject(o) Then Set r=o Else r=o End If End Function","VBScript"):c=p));return c}({});m.refineScope=m.refineScope||i;return i.refine=i.refinejs=m});
