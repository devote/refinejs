...
"Property Get ["+c+"]","Call VBCorrectVal("+(b===1?i.__get?'me.[__get].call(me,"'+c+'")':"":j[a]&&(b!==5||j[a].get)?"[(accessors)].["+a+"]"+(b===5?".get":"")+".call(me,a)":"window.undefined")+",["+c+"])","End Property");if(b&1||b===4)l.push("Public Property Let ["+c+"](val)",b=(b===1?i.__set?'Call me.[__set].call(me,"'+c+'",val)':"":b===4?"Set [(accessors)].["+a+"]=val":j[a]&&(b!==5||j[a].set)?"Call [(accessors)].["+a+"]"+(b===5?".set":"")+".call(me,val)":"")+"\nEnd Property","Public Property Set ["+
