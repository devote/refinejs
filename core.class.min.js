/*
 * core.class.min.js Library for JavaScript v0.5.5.1
 *
 ...
 * Update: 30-01-2013
 */
(function(q,t,r,s,K){function B(b,f){return function(){throw Error("'"+b+"' property is "+(f?"read":"write")+"-only");}}function n(){function b(){for(var a=D,g=0===+this,i=arguments,l=s,m=new C,n=i[2]||s,h=n||m,k=g?i[0]:{a:m},o=!g||i[1]===K||w!==K?w:i[1];a--;)"string"===typeof y[a]&&(y[a]=E(y[a],L,b)),e=function(){},e.prototype=l=y[a].call(r,k,o,n),0<a&&!o&&(e.prototype.constructor=function(){}),h=n=new e;o||(m.parent=l);if(D||g)e=function(a,c,b){a[c]=function(){var a=k.a.parent,c=k.a.__class__;k.a.parent=
...
e[a]&&!(e[a]instanceof Array)?e[a--]:{},m=l.statics||(l.context||l["extends"]||l["implements"]||l.compact?{}:l),i="function"===typeof e[a]||"string"===typeof e[a-1]||e[a]&&e[a]instanceof Array?e[a--]:"",g=((e[a--]||"")+(i&&"string"==typeof i?" extends "+i:"")).replace(/^[\s]+|[\s](?=\s)|[\s]+$/g,"").replace(/\s*,\s*/g,",").split(" "),L=e[a--]||l.context||n.defaultContext||q,o=!(g[0]in k)&&g.shift()||"",p=(a=g.shift())in k&&(k=g.shift())?k.split(","):i instanceof Array?i:[],v="extends"===a?(a=g.shift(),
p.shift()):"",g="implements"===a?p.concat((k=g.shift())?k.split(","):[]):p,k=l["extends"]||v||"string"===typeof i&&i,i=l["implements"]||g,y=i instanceof Array?(k&&i.unshift(k),i):k&&[k,i]||[i],D=y.length,w=l.compact;if("function"!==typeof C)var A=C,C=function(){return A};b.toString=function(){return"[class "+(o||"Object")+"]"};u(m,function(a,c){b[a]=c});if(b.className=o){l=L;e=(g=o.split(".")).shift();do 0===g.length?l[t=e]=b:(e in l||(l[e]={}),l=l[e]);while(e=g.shift())}return b}var p=q.document,
