...
c+"](val)",b)}if(!b){if(o.length===50){l.push("Public ["+o.join("],[")+"]");o.length=0}o[o.length]=a}},1);B?(l.push((o.length?"Public ["+o.join("],[")+"]\n":"")+"Private [(accessors)]","Private Sub Class_Initialize()","Set [(accessors)]="+c+"FactoryJS()","End Sub","End Class","Function "+c+"Factory()","Set "+c+"Factory=New "+c,"End Function"),q[c+"FactoryJS"]=function(){return d},execVBScript(l.join("\n"))):(j=0,c=r);o=l=r}c&&(d={},s(j,function(a){d[a]=i[a]}),e.a=q[c+"Factory"](),s(i,function(a,b){if(!j.hasOwnProperty(a))if((!z||
