 ...
 * Update: 13-02-2013
 */
(function(s,E,u,v,F){function D(d,l){return function(){throw Error("'"+d+"' property is "+(l?"read":"write")+"-only");}}function w(){}function i(){function d(){for(var h=G,j=0===+this,i=arguments,p=v,o=new r,t=p&&i[2]||v,f=t||o,m=j?i[0]:{a:o},z=!j||i[1]===F||H!==F?H:i[1];h--;)"string"===typeof C[h]&&(C[h]=I(C[h],P,d)),w.prototype=p=C[h].call(u,m,z,t),0<h&&!z&&(p.constructor=function(){}),f=t=new w;z||(o.parent=p);if(G||j)e=function(b,c,k){b[c]=function(){var c=m.a.parent,b=m.a.__class__;m.a.parent=
