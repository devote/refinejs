/*
 * light.core.class.min.js Library for JavaScript v0.5.5
 *
 ...
 * Update: 30-01-2013
 */
(function(r,x,s,t,N){function A(c,k){return function(){throw Error("'"+c+"' property is "+(k?"read":"write")+"-only");}}function p(){function c(){for(var f=C,e=0===+this,i=arguments,p=t,m=new B,o=i[2]||t,d=o||m,n=e?i[0]:{a:m},w=!e||i[1]===N?L:i[1];f--;)"string"===typeof z[f]&&(z[f]=D(z[f],M,c)),a=function(){},a.prototype=p=z[f].call(s,n,w,o),0<f&&!w&&(a.prototype.constructor=function(){}),d=o=new a;w||(m.parent=p);if(C||e)a=function(h,j,a){h[j]=function(){var h=n.a.parent,j=n.a.__class__;n.a.parent=
m.parent;n.a.__class__=d.__class__;var b=a.apply(this===d||this==r?n.a:this,arguments);n.a.__class__=j;n.a.parent=h;return b};h[j].toString=function(){return a.toString()}},u(m,function(h,j){"function"===typeof j&&!w?a(d,h,j):(!w&&j&&"object"===typeof j&&("set"in j&&"function"===typeof j.set&&a(j,"set",j.set),"get"in j&&"function"===typeof j.get&&a(j,"get",j.get)),d[h]=j)}),n.a=e?n.a:d;w||(e&&q in d&&(d.constructor=d[q]),d.__class__=c);if(!e&&0!==l)if(E){if(F){if(b===s){b="StaticClass"+O+E++;var v=
